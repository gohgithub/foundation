                  ...
                  <hr data-aos="fade-up">
                    ...
                    <ul class="select-item container-inner mt-60">
                      ...
                      <li data-aos="fade-up">
                        ...
                        <p>若需要終止初期懷孕的服務，建議可以直接到<a href="https://www.hpa.gov.tw/Pages/Detail.aspx?nodeid=518&pid=552" target="_blank">「青少年親善醫師門診名單」</a>，找尋離你最近，或是讓你最安心的醫師為你診斷。為了提供青少年良好的醫療環境，專為未滿20歲之青少年、以及20~24歲青年創立親善門診。溫馨的候診空間，讓你安心不焦慮，也非常注重你的隱私權，門診費用都是青少年可負擔得起，若有需要也可以協助你與父母進行溝通。 </p>
                      </li>
                      <li data-aos="fade-up">
                        <h3>沒有錢可以進行手術怎麼辦？</h3>
