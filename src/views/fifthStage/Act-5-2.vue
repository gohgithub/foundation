      ...
      <main>
        ...
        <section class="container" data-aos="fade-down"  data-aos-delay="500">
          <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb" class="badge">
            ...
            <li class="breadcrumb-item active" aria-current="page"><router-link to="">已分手，獨自撫養</router-link></li>
            </ol>
          </nav>
        </section>
                    ...
                    <ul class="select-item container-inner mt-60">
                      ...
                      <li data-aos="fade-up">
                        ...
                        <ul class="list mb-60">
                          ...
                          <li>2.若未滿18歲時，父母是有義務負擔子女的行為責任，因為在民法上20歲以前的青少男女都是限制行為能力人，因此他們除了有義務維繫子女的經濟狀況外，也有義務照顧子女在非預期懷孕下所生的小孩。</li>
                        </ul>
                      </li>
                    </ul>
                    <!-- 選項結束 -->
