                ...
                <ul>
                  ...
                  <li data-aos="fade-up">
                    <a class="line-item" href="#">
                      <i class="fab fa-line fa-2x line-icon"></i>
            ...
            <div class="form-box">
              <Form v-slot="{ errors }" @submit="onSubmit" autocomplete="off">
                ...
                <label data-aos="fade-up" class="signUp-label py-0" for="再次輸入密碼">
                  ...
                  <Field v-model="signUpData.confirmPassword" maxlength="13" rules="required|passwordConfirmed:@密碼" :class="{ 'outline-danger': errors['再次輸入密碼'] }" class="signUp-input signUp-ConPassword" name="再次輸入密碼" type="password" placeholder="請再次輸入密碼" />
                </label>
                ...
                <label data-aos="fade-up" class="signUp-label py-0 pb-50">
                  ...
                  <Field name="出生日期" rules="required">
                    <flat-pickr name="出生日期" v-model="signUpData.born" class="signUp-input mb-15" placeholder="YYYY/MM/DD(無法修改，請正確填寫)"></flat-pickr>
                  </Field>
