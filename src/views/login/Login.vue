      ...
      <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
          <div class="modal-body">
            ...
            <p>五、各項通知服務、相關訊息之停止寄送，可透過訊息內容提供之取消訂閱連結通知。您可於上班時間聯繫本平台（電話(04)2206-2121，分機2261）。就違反本個資聲明之行為，請Email至社工室信箱 swr@mail.cmuh.org.tw反映。</p><br>

            <ul class="mt-60">
              <p>個人資料同意提供：</p>
              <li>「我同意」授權貴平台於所列目的之必要合理範圍內，蒐集、處理及利用本人之個人資料。</li>
              <li>法規之要求，並提供予貴平台留存及日後查證使用。</li>
            </ul>
          </div>
