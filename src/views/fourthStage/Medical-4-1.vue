                  ...
                  <hr data-aos="fade-up">
                    ...
                    <ul class="select-item container-inner mt-60">
                      ...
                      <li data-aos="fade-up">
                        ...
                        <p>如果是未滿20歲的未成年人士，只是單純就診，並不會通知父母或主管機關；但如果確定要執行終止懷孕的相關手術及療程就會需要法定代理人或配偶的同意。但是，如果你是未滿16歲的未成年人士，由於在法律中你的身分仍屬於限制行為能力者，所以有關重要的事(就學、就醫等等)，皆需法定監護人協助與陪同。所以當你獨自就診時，醫院就有需要通知你的監護人或主管機關來幫忙。主管機關的角色是來協同你將此事處理得更完整，或確保你的權益不會因為年紀、身分而受損。</p>
                      </li>
                      <li data-aos="fade-up">
