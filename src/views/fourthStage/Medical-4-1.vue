                ...
                <div class="select-menu">
                  ...
                  <hr data-aos="fade-up">
                    ...
                    <ul class="select-item container-inner mt-60">
                      <li data-aos="fade-up">
                        <h3>什麼是中止懷孕？</h3>
                        <p>中址懷孕又可稱為終止懷孕、墮胎、人工流產、終止妊娠。你可以透過手術或口服藥物的方式，將胎兒從子宮內清除。隨著懷孕時間的長短不同會有不同的執行療程和影響，以及法律規範。若透過合法管道進行醫療流程，會有醫師給予適時的檢查與手術，可以降低風險。反之，若沒有依循合法正常的途徑或太晚執行終止懷孕，很有可能會對身體留下永久的傷害。<br>
                      ...
                      <li data-aos="fade-up">
                        ...
                        <p>如果是未滿20歲的未成年人士，只是單純就診，並不會通知父母或主管機關；但如果確定要執行中止懷孕的相關手術及療程就會需要法定代理人或配偶的同意。但是，如果你是未滿16歲的未成年人士，由於在法律中你的身分仍屬於限制行為能力者，所以有關重要的事(就學、就醫等等)，皆需法定監護人協助與陪同。所以當你獨自就診時，醫院就有需要通知你的監護人或主管機關來幫忙。主管機關的角色是來協同你將此事處理得更完整，或確保你的權益不會因為年紀、身分而受損。</p>
                      </li>
                      <li data-aos="fade-up">
