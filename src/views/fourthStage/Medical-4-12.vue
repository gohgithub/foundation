      ...
      <section class="container" data-aos="fade-down"  data-aos-delay="500">
        <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb" class="badge">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"><router-link to="">有哪些避孕方法呢？</router-link></li>
          </ol>
        </nav>
      </section>
              ...
              <div class="select-menu">
                ...
                <hr data-aos="fade-up">
                  ...
                  <ul class="select-item container-inner mt-60">
                    <li data-aos="fade-up">
                      <p>避孕方法有很多種，請洽詢您的專業醫藥人員討論適合你的方法。包括常規避孕藥、避孕貼片、陰道環、子宮帽、長效注射藥物、子宮內避器、性交後緊急避孕法。</p>
                    </li>
                  </ul>
                  <!-- 選項結束 -->
                  <hr data-aos="fade-up">
