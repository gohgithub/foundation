        ...
        <section class="container" data-aos="fade-down"  data-aos-delay="500">
          <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb" class="badge">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">未滿 16 歲</a></li>
            </ol>
          </nav>
        </section>
                ...
                <div class="select-menu">
                  ...
                  <hr data-aos="fade-up">
                    ...
                    <ul class="select-item container-inner mt-60">
                      <li data-aos="fade-up">
                        <p>想必你現在很擔心，但是第一步還是要先確認是否有懷孕喔。
法律上為了保護未滿16歲的青少年們身心健康，規範這個年齡層不適合發生性行為，因此當診所、醫院知道這個狀況，就保護青少年的立場，還是會通知社會局社工人員關懷你的狀況喔
 </p>
                      </li>
                    </ul>
                    <!-- 選項結束 -->
