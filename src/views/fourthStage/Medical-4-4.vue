        ...
        <section class="container" data-aos="fade-down"  data-aos-delay="500">
          <nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb" class="badge">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="#">分娩計畫</a></li>
            </ol>
          </nav>
        </section>
...
不過，若生產過程中出現緊急情況，仍須使用，例如：出現胎兒無法順利娩出，心跳微弱、需使用真空吸引，但會陰部延展度不夠，無法放入真空吸引器時，就必須進行會陰切開。
                      ...
                      <a data-aos="fade-up" href="https://257085.sfaa.gov.tw/information_detail.php?Key=26">參考來源：https://257085.sfaa.gov.tw/information_detail.php?Key=26</a>
                      <a data-aos="fade-up" href="https://www.mombaby.com.tw/articles/9921277">另外也可參考：規劃生產計畫書，從3階段8項目著手，孕媽咪也能表達對生產的期待！
</a>
                    </ul>
                    <!-- 選項結束 -->
                    <hr data-aos="fade-up">
